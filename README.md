...
[![Open in GitHub Codespaces](https://github.com/codespaces/badge.svg)](https://codespaces.new/shyndman/ha-mqtt-media-bridge?quickstart=1)
...
[![Open your Home Assistant instance and open a repository inside the Home Assistant Community Store.](https://my.home-assistant.io/badges/hacs_repository.svg)](https://my.home-assistant.io/redirect/hacs_repository/?owner=jpawlowski&repository=ha-mqtt-media-bridge&category=integration)
...
1. Download the `custom_components/mqtt_media_bridge/` folder from this repository
...
[![Open your Home Assistant instance and start setting up a new integration.](https://my.home-assistant.io/badges/config_flow_start.svg)](https://my.home-assistant.io/redirect/config_flow_start/?domain=mqtt_media_bridge)
...
3. Search for "MQTT Media Bridge"
...
Find all entities in **Settings** → **Devices & Services** → **MQTT Media Bridge** → click on the device.
...
### `mqtt_media_bridge.example_action`
...
```yaml
service: mqtt_media_bridge.example_action
data:
  # Add your parameters here
```

### `mqtt_media_bridge.reload_data`
...
```yaml
service: mqtt_media_bridge.reload_data
```
...
logger:
  default: info
  logs:
    custom_components.mqtt_media_bridge: debug
```
...
4. Check the integration diagnostics (Settings → Devices & Services → MQTT Media Bridge → 3 dots → Download diagnostics)
...
**Made with ❤️ by [@shyndman][user_profile]**
